<?php
/**
 * Create Post wordpress with simple html dom
 * 
 * NOTICE OF LICENSE
 * 
...
if(isset($_POST) && $_POST){
    ...
    function scrapingData($data,$classTitle,$classContent) {
        ...
        $myData['title'] = $html->find("h1[class='single-post-title']", 0)->innertext;
        $myData['content'] = $html->find("div[class='theiaStickySidebar']", 0)->innertext;
   ...
   $categoryID = '45'; // set to category id.
